...
class FaceRecognizer:
    def __init__(self, dataset_path, config_path="config.json"):
        ...
        self.TELEGRAM_BOT_TOKEN = "7856772587:AAEvaQpDMLGiTNGktZbXB4GA4P8mW9NFZ5Y" # Пример: "123456789:ABCdefGHIjklMNOpqrSTUvwxYZ"
        self.TELEGRAM_CHAT_ID = "5009077307" # Пример: "1234567890"
